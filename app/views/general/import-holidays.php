...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Import holidays</h1>
    <div class="text-left">
        ...
        <div class="col-lg-8">
            <div class="card mb-0 shadow">
                <div class="card-body">
                    ...
                    <div class="col-lg">
                    <form action="<?= BASEURL; ?>/holidays/importdata" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group text-right">
                            ...
                            <a href="<?= BASEURL; ?>/holidays/download" class="btn btn-danger mr-2">
                                <span class="icon text-white-50">
