...
<div class="container-fluid">
    ...
    <div class="text-right">
        <a href="<?= BASEURL; ?>/progress" class="btn btn-outline-secondary btn-sm mb-3"><i class="fas fa-sync-alt"></i></a>
        <?php if ($create > 0) { ?>
            <a href="<?= BASEURL; ?>/progress/add_progress" class="btn btn-primary btn-sm mb-3">
    ...
    <div class="card text-center shadow">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= BASEURL; ?>/progress"><b>Progress WO</b></a>
                </li>
                <?php }
                ...
                <table class="table table-hover">
                    <thead class="thead-light">
                        ...
                        <tr>
                            ...
                            <th>Progress Work Order</th>
                            <th class="judul">Target</th>
                            <th>PIC</th>
                    ...
                    <tbody>
                        ...
                        foreach ($data['progress'] as $progress) : ?>
                            <tr>
                                ...
                                <td class="judul"><?= $progress['target']; ?> hari kerja</td>
                                <td><?= $progress['pic']; ?></td>
                                <td class="judul">
                                    <?php if ($update > 0) { ?>
                                        <a href="<?= BASEURL; ?>/progress/edit_progress/<?= $progress['id_progress']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-fw fa-pen"></i></a> <?php } ?>
                                    <?php if ($delete > 0) { ?>
                                        <a href="<?= BASEURL; ?>/progress/hapusprogress/<?= $progress['id_progress']; ?>" class="btn btn-danger btn-sm tombol-hapus"><i class="fas fa-fw fa-trash-alt"></i></i></a> <?php } ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
