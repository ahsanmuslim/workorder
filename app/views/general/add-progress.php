        ...
        <div class="col-lg-8">
            <div class="card mb-0 shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah progress</h6>
                </div>
                <div class="card-body">
                    <style>
                    ...
                    <div class="col-lg">
                    <form action="<?= BASEURL; ?>/progress/tambahprogress" method="post">
                        <div class="form-group">
                            <label for="progress">Progress</label>
                            <input type="text" name="progress" id="progress" class="form-control" required autofocus>
                        </div>
                        <div class="form-group">
