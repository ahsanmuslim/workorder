...
<div class="container-fluid">
    ...
    <div class="text-right">
        <a href="<?= BASEURL; ?>/supplier" class="btn btn-outline-secondary btn-sm mb-3"><i class="fas fa-sync-alt"></i></a>
        <?php if ($create > 0) { ?>
            <a href="<?= BASEURL; ?>/supplier/add_supplier" class="btn btn-primary btn-sm mb-3">
    ...
    <div class="card text-center shadow">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= BASEURL; ?>/supplier"><b>Supplier</b></a>
                </li>
                <?php } ?>
            </ul>
        </div>
        <div class="card-body text-left">
            ...
            <div class="table-responsive mt-2">
                <table id="tblsupplier" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        foreach ($data['supplier'] as $supplier) : ?>
                            <tr>
                                ...
                                <td class="judul">
                                    <?php if ($update > 0) { ?>
                                        <a href="<?= BASEURL; ?>/supplier/edit_supplier/<?= $supplier['id_supplier']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-fw fa-pen"></i></a> <?php } ?>
                                    <?php if ($delete > 0) { ?>
                                        <a href="<?= BASEURL; ?>/supplier/hapusSupplier/<?= $supplier['id_supplier']; ?>" class="btn btn-danger btn-sm tombol-hapus"><i class="fas fa-fw fa-trash-alt"></i></i></a> <?php } ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
