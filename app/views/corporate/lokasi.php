...
<div class="container-fluid">
    ...
    <div class="text-right">
        <a href="<?= BASEURL; ?>/lokasi" class="btn btn-outline-secondary btn-sm mb-3"><i class="fas fa-sync-alt"></i></a>
        <?php if ($create > 0) { ?>
            <a href="<?= BASEURL; ?>/lokasi/add_lokasi" class="btn btn-primary btn-sm mb-3">
    ...
    <div class="card text-center shadow">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= BASEURL; ?>/lokasi"><b>Lokasi</b></a>
                </li>
                <?php }
                    ...
                    <tbody>
                        ...
                        foreach ($data['lokasi'] as $lokasi) : ?>
                            <tr>
                                ...
                                <td class="judul">
                                    <?php if ($update > 0) { ?>
                                        <a href="<?= BASEURL; ?>/lokasi/edit_lokasi/<?= $lokasi['id_lokasi']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-fw fa-pen"></i></a> <?php } ?>
                                    <?php if ($delete > 0) { ?>
                                        <a href="<?= BASEURL; ?>/lokasi/hapusLokasi/<?= $lokasi['id_lokasi']; ?>" class="btn btn-danger btn-sm tombol-hapus"><i class="fas fa-fw fa-trash-alt"></i></i></a> <?php } ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
