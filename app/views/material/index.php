...
<div class="container-fluid">
    ...
    <div class="text-right">
        <a href="<?= BASEURL; ?>/material" class="btn btn-outline-secondary btn-sm mb-3"><i class="fas fa-sync-alt"></i></a>
        <?php if ($create > 0) { ?>
            <a href="<?= BASEURL; ?>/material/tambah" class="btn btn-primary btn-sm mb-3">
    ...
    <div class="card mb-2 shadow">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="tblmaterial">
                    ...
                    <tbody>
                        ...
                        foreach ($data['material'] as $mat) : ?>
                            <tr>
                                ...
                                <td><?= $mat['jenis_material']; ?></td>
                                <td class="judul"><?= $mat['stok']; ?></td>
                                <td><?= $mat['satuan']; ?></td>
                                <td>Rp <?= number_format($mat['harga']); ?></td>
                                <td><?= $mat['keterangan']; ?></td>
                                <td class="judul">
                                    <?php if ($update > 0) { ?>
                                        <a href="<?= BASEURL; ?>/material/edit/<?= $mat['id_material']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-fw fa-pen"></i></a> <?php } ?>
                                    <?php if ($delete > 0) { ?>
                                        <a href="<?= BASEURL; ?>/material/hapus/<?= $mat['id_material']; ?>" class="btn btn-danger btn-sm tombol-hapus"><i class="fas fa-fw fa-trash-alt"></i></i></a> <?php } ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
